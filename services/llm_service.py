...
SYSTEM_PROMPT = (
    ...
    "or anything that requires up-to-date information, use the web_search tool to look it up. "
    "Do not say 'I don't have access to real-time information' — search for it instead.\n\n"
